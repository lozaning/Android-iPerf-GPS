...
public final class ActivityExportBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton exportCsvButton;
  ...
  private ActivityExportBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull MaterialButton deleteButton, @NonNull MaterialButton exportCsvButton,
  ...
  public static ActivityExportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MaterialButton exportCsvButton = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityExportBinding((ConstraintLayout) rootView, appBarLayout,
          bottomButtonsLayout, deleteButton, exportCsvButton, selectAllButton, sessionsRecyclerView,
          toolbar);
    }
